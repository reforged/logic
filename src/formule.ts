...
function isFilterData (node): node is ConditionContract {
  return (node as ConditionContract).kind !== undefined
}
...
export class Formule {
  ...
  constructor(condition: ConditionContract) {
   ...
   * @param data
   */
  public buildTree (data: ConditionContract): Prop {
